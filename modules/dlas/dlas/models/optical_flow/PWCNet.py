...
from models.flownet2.networks.correlation_package.correlation import (
...
class PWCDCNet(nn.Module):
    ...
    def __init__(self, md=4, pretrained=False):
        ...
        self.dc_conv2 = conv(128,      128, kernel_size=3,
                             stride=1, padding=2,  dilation=2)
        self.dc_conv3 = conv(128,      128, kernel_size=3,
                             stride=1, padding=4,  dilation=4)
        self.dc_conv4 = conv(128,      96,  kernel_size=3,
                             stride=1, padding=8,  dilation=8)
        self.dc_conv5 = conv(96,       64,  kernel_size=3,
                             stride=1, padding=16, dilation=16)
        self.dc_conv6 = conv(64,       32,  kernel_size=3,
